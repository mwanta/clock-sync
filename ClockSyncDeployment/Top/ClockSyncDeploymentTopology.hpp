// ======================================================================
// \title  ClockSyncDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CLOCKSYNCDEPLOYMENT_CLOCKSYNCDEPLOYMENTTOPOLOGY_HPP
#define CLOCKSYNCDEPLOYMENT_CLOCKSYNCDEPLOYMENTTOPOLOGY_HPP
// Included for access to ClockSyncDeployment::TopologyState and ClockSyncDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <ClockSyncDeployment/Top/ClockSyncDeploymentTopologyDefs.hpp>
 ...
 * ClockSyncDeployment::TopologyState see: ClockSyncDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type ClockSyncDeployment::TopologyState see: ClockSyncDeploymentTopologyDefs.hpp.
 *
