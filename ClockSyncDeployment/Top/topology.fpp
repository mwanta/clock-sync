module ClockSyncDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "ClockSyncDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections ClockSyncDeployment {

    }

    connections TimeSync {
      # Commands auto-connected by: command connections instance cmdDisp
      # Time auto-connected by: time connections instance posixTime
  
      # Only manual connections if you have GPS with PPS:
      # gps.ppsOut -> timeSync.ppsSignal
    }
